...
class _CalendarWidgetState extends State<CalendarWidget> {
  ...
  List<Reservation> reservations = [
    ...
    Reservation(
      ...
      title: 'ATH Tennis',
      court: 'Court C',
      startTime: DateTime.parse('2024-05-23 14:00:00'),
      endTime: DateTime.parse(
          '2024-05-23 16:00:00'), // Example of upcoming reservation
    ),
    Reservation(
      id: 4,
      title: 'Ceid',
      court: 'D Class',
      startTime: DateTime.parse('2024-05-25 14:00:00'),
      endTime: DateTime.parse('2024-05-25 18:00:00'),
    ), // Example of upcoming reservation
